...
prompt Created on 2014年12月26日 by Administrator
set feedback off
set define off
...
values ('admin', 'TST8VBeOTpV+bm9XrqTl5w==', null, '管理员', 'admin@sand.com.cn', '021-64031111', '2014-12-26 17:17:38', '0:0:0:0:0:0:0:1', '本系统超级管理员', 0, 1);
insert into SYSTEM_USER (USERNAME, USER_PASSWD, COMPANY_ID, NAME, EMAIL, PHONENUMBER, LAST_LOGIN, LAST_IP, USER_DESC, USTATE, ROLE_ID)
